...
def custom_insert(input_list, index, value):
    ...
    input_list[index: index+1] = 2*input_list[index: index+1]
...
def custom_remove(input_list, value):
    ...
    """
    a = ["None"]
    len_input = custom_len(input_list)
    new_list = (len_input-1)*a
    index_c = None
    for i in range(len_input):
        if input_list[i] == value:
            ...
            pass
    new_list[:index_c] = input_list[:index_c]
    new_list[index_c:] = input_list[index_c+1:]
